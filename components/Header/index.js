            ...
            >
              {!isBlog ? (
                <div className="grid grid-cols-1">
                  <Button onClick={handleWorkScroll}>Education</Button>
                  <Button onClick={handleAboutScroll}>About</Button>
                  {showBlog && (
                    <Button onClick={() => router.push("/blog")}>Intrests</Button>
                  )}
                  <Button
                    onClick={() => window.open("mailto:easyaditi@gmail.com")}
                  >
                    Contact
                  </Button>
                </div>
      ...
      >
        ...
        {!isBlog ? (
          <div className="flex">
            ...
            <Button onClick={() => window.open("mailto:easyaditi@gmail.com")}>
              Contact
            </Button>
